...
The source files include an earlier screenshot-replay build script for reproducibility; the active cursor demo and both encodings are generated by `scripts/build-cursor-video.js <run-id>` from recorded mouse events. Actions remain at normal speed; reasoning pauses are shortened. Original videos are linked separately. Regenerate the landing and reports with `node scripts/build-showcase.js 310463c3-c942-41ea-a921-5a58fbe63bab 3c643512-edd7-4252-869c-c25c2410075b` (requires the local evidence runs).
